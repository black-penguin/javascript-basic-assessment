...
var firstHero=heroes.splice(0,1).join("");
...
function makeChatMessage(messge, athr)
{
	var chatMessage=
	{
		message:messge,
...
//Jeremy and then changes the person object to have a property called lovesCode with a value of 10.
